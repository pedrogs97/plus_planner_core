...
class DocumentModel(BaseModel):
    ...
    patient = fields.ForeignKeyField("models.PatientModel", related_name="documents", on_delete=fields.NO_ACTION)
...
class TreatmentPatientModel(BaseModel):
    ...
    patient = fields.ForeignKeyField("models.PatientModel", related_name="treatments", on_delete=fields.NO_ACTION)
    treatment = fields.ForeignKeyField("models.TreatmentModel", related_name="patients", on_delete=fields.NO_ACTION)
...
class QuestionModel(BaseModel):
    ...
    anamnesis = fields.ForeignKeyField("models.AnamnesisModel", related_name="questions", on_delete=fields.NO_ACTION)
...
class AnswerModel(BaseModel):
    ...
    question = fields.ForeignKeyField("models.QuestionModel", related_name="answers", on_delete=fields.NO_ACTION)
    patient = fields.ForeignKeyField("models.PatientModel", related_name="answers", on_delete=fields.NO_ACTION)
