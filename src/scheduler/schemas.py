...
# from src.backends import check_clinic_id, check_desk_exist, check_desk_vacancy
...
class SchedulerMessage(Message):
    """Scheduler Message Schema"""

    message_type: SchedulerMessageType = Field(alias="messageType")
    data: Optional[
        Union[
            AddEventSchema,
            EditEventSchema,
