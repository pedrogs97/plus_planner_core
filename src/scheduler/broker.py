...
from src.scheduler.message import Message, untag_broker_message
...
class BrokerInterface(ABC):
    ...
    @abstractmethod
    async def get_message(self, **kwargs) -> Union[Message, None]: ...
...
def create_broker(broker_url: str, **kwargs) -> BrokerInterface:
    ...
    if url.scheme == "redis":
        raise ValueError("Redis is not supported yet")
